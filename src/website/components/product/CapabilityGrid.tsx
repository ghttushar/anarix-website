...
const cards = [
  ...
  { icon: Shield, title: "Guardrails and Safety Controls", desc: "Every automated action is protected by blast radius limits, stockout guards, and one-click rollback. 24/7 guardrailed execution with transparent logging.", features: ["Daily blast radius limits", "Stockout-aware inventory guards", "One-click rollback on all actions", "24/7 transparent execution logging"] },
