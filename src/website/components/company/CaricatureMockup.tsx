  ...
  return (
    ...
    >
      ...
      {hair === 0 && (
        ...
        <g>
          <path
            d="M 28 42 Q 28 18 50 16 Q 72 18 72 42 Q 70 32 50 30 Q 30 32 28 42 Z"
            fill={`url(#${id}-hair)`}
          />
          <path
            d="M 30 38 Q 40 30 50 30 Q 60 30 70 38"
            fill="none"
            stroke={t.hairHi}
            strokeWidth="1"
            opacity="0.7"
      ...
      {hair === 1 && (
        ...
        <g>
          <path
            d="M 26 44 Q 24 18 52 16 Q 74 22 72 44 Q 64 28 46 30 Q 32 32 26 44 Z"
            fill={`url(#${id}-hair)`}
          />
          <path
            d="M 32 28 Q 50 22 66 32"
            fill="none"
            stroke={t.hairHi}
            strokeWidth="0.8"
            opacity="0.6"
      ...
      {hair === 2 && (
        ...
        <g>
          <path
            d="M 30 40 Q 32 24 50 22 Q 68 24 70 40 Q 62 32 50 32 Q 38 32 30 40 Z"
            fill={`url(#${id}-hair)`}
          />
        </g>
      )}
      {hair === 3 && (
        ...
        <g>
          <path
            d="M 26 40 Q 24 18 50 16 Q 76 18 74 40 L 74 70 Q 68 50 56 46 L 56 30 Q 50 28 44 30 L 44 46 Q 32 50 26 70 Z"
            fill={`url(#${id}-hair)`}
          />
          <path
            d="M 30 30 Q 50 22 70 30"
            fill="none"
            stroke={t.hairHi}
            strokeWidth="0.8"
            opacity="0.6"
      ...
      {hair === 4 && (
        ...
        <g>
          <path
            d="M 32 38 Q 34 24 50 22 Q 66 24 68 38 Q 60 32 50 32 Q 40 32 32 38 Z"
            fill={`url(#${id}-hair)`}
          />
          <ellipse cx="50" cy="20" rx="8" ry="7" fill={`url(#${id}-hair)`} />
          <path
            d="M 44 18 Q 50 14 56 18"
            fill="none"
            stroke={t.hairHi}
            strokeWidth="0.8"
            opacity="0.6"
      ...
      <path
        d={`M 36 44 Q 41 ${42 - lookX * 0.5} 46 44`}
        stroke={t.hair}
        strokeWidth="1.4"
        fill="none"
        strokeLinecap="round"
      />
      <path
        d={`M 54 44 Q 59 ${42 + lookX * 0.5} 64 44`}
        stroke={t.hair}
        strokeWidth="1.4"
        fill="none"
        strokeLinecap="round"
      ...
      />
      <path
        d="M 50.5 56 Q 51.6 58 50.4 59.4"
        stroke={t.skinShade}
        strokeWidth="0.7"
        opacity="0.55"
        fill="none"
      ...
      {beard && (
        <g>
          <path
            d="M 36 58 Q 50 74 64 58 Q 60 68 50 70 Q 40 68 36 58 Z"
            fill={`url(#${id}-hair)`}
            opacity="0.92"
          />
          <path
      ...
      {earring && <circle cx="29" cy="56" r="1.2" fill={t.accent} />}
    </svg>
  );
}
