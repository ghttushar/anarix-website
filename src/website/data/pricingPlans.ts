    ...
    sections: [
      {
        ...
        comparison: [
          ...
          { feature: "Jiva AI Copilot", values: ["Basic", "Full"] },
    ...
    sections: [
      {
        ...
        comparison: [
          ...
          { feature: "Jiva-generated Audits", values: [false, true, true] },
